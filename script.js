...
const commands = [
    ...
    function displayProjects() {
        ...
        projectList += '<li><a href="#">Jeu "FISK" (java), variante de Risk</a></li>';
        projectList += '</ol>';
    ...
    function contact() {
        var message = 'Vous pouvez me contacter par les moyens ci-dessous :<br><br>Mail : lobaladier@gmail.com <br>Tel : +33 7 62 07 67 65<br><a href="https://www.linkedin.com/a remplir" target="_blank">Voir mon LinkedIn</a>';
        output.innerHTML = message;
    }
    
    // Script pour la fonction "à propos"
    function about() {
        var message = "A modifier...";
        output.innerHTML = message;
    }
